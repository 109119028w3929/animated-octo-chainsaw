...
public class Expense extends RealmObject {
    ...
    public Expense(String description, Date date, @IExpensesType int type, Category category, float total,String filepath) {
...
//            cloneExpense.setFilepath(expense.getFilepath());
