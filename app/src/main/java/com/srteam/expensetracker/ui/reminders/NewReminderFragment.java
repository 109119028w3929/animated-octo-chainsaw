...
import com.srteam.expensetracker.entities.Reminder;
...
public class NewReminderFragment extends BaseFragment implements View.OnClickListener{
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.tv_day) {
            ...
            TimePickerDialog timePickerDialog = DialogManager.getInstance().createTimePickerDialog(getActivity(), hour, minute ,new TimePickerDialog.OnTimeSetListener() {
                @Override
            ...
            if(timePickerDialog!=null){
                timePickerDialog.setOnShowListener(new DialogInterface.OnShowListener() {
                    ...
                    public void onShow(DialogInterface dialogInterface) {
                        ...
                        positiveButton.setTextColor(ContextCompat.getColor(getContext(), R.color.colorAccentGreen));

                        Button negativeButton = timePickerDialog.getButton(DialogInterface.BUTTON_NEGATIVE);
                        negativeButton.setTextColor(ContextCompat.getColor(getContext(), R.color.colorAccentRed));
                    }
                });
